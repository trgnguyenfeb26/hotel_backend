      ...
      <div class="info">
        ...
        <el-dropdown @command="handleCommand">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item command="info">Xem thông tin cá nhân</el-dropdown-item>
      ...
      <el-aside>
        ...
        >
          <el-menu-item index="0" @click="handleNav">
            ...
            <span slot="title">Mở rộng/Thu gọn menu</span>
          </el-menu-item>
