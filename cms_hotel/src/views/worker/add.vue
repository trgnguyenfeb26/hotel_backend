  ...
  <el-card class="app-container" shadow="always">
    ...
    <el-form ref="form1" :model="form1" :rules="rules2" label-width="120px">
      <el-form-item
        ...
        <el-input v-model="form1.username" placeholder="Vui lòng nhập tên người dùng, sử dụng để đăng nhập, không thể thay đổi"/>
      </el-form-item>
      <el-form-item
        label="Mật khẩu"
        prop="password"
      ...
      <el-form-item
        ...
        prop="name"
      >
        <el-input v-model.number="form1.name" placeholder="Vui lòng nhập họ và tên thật"/>
      </el-form-item>
      <el-form-item
        label="Số điện thoại"
        prop="phone"
